...
public abstract class AutoHeightLayout extends SoftKeyboardSizeWatchLayout
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.d(TAG, "onSizeChanged()" + "mMaxParentHeight = [" + mMaxParentHeight + "], h = [" + h + "]" + " mSoftKeyboardHeight =" + mSoftKeyboardHeight);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d(TAG, "onMeasure mMaxParentHeight=" + mMaxParentHeight);
