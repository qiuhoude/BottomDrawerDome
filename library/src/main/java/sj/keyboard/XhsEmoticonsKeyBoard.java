...
public class XhsEmoticonsKeyBoard extends AutoHeightLayout implements View.OnClickListener, EmoticonsFuncView.OnEmoticonsPageViewListener,
    ...
    protected void initFuncView() {
        initEmoticonFuncView(); //表情的窗口
        initEditView(); //编辑框
    }

    //TODO
    public void hideFuncLayout() {
        mLyKvml.setVisibility(false);
        onFuncChange(1);
    }



    public void showuncLayout() {
...
//        Log.d("qiu", "onSoftKeyboardHeightChanged() called with: " + "height = [" + height + "]");
    ...
    public void OnSoftPop(int height) {
        ...
        mLyKvml.setVisibility(true);
        onFuncChange(mLyKvml.DEF_KEY);
        Log.d("qiu", "OnSoftPop height = " + height);
