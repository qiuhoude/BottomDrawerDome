...
import com.xhsemoticonskeyboard.activity.ChatMapActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    @OnClick(R.id.btn_simple_chat_fullscreen)
    void btn_simple_chat_fullscreen() {
        startActivity(new Intent(MainActivity.this, SimpleChatActivity.class));
    }

    @OnClick(R.id.btn_simple_chat_translucent)
    void btn_simple_chat_translucent() {
        startActivity(new Intent(MainActivity.this, SimpleTranslucentChatActivity.class));
    }

    @OnClick(R.id.btn_simple_chat_coordinatorlayout)
    void btn_simple_chat_coordinatorlayout() {
    ...
    @OnClick(R.id.btn_chat_map)
    void btn_chat_map() {
        ChatMapActivity.show(this);
    }
}
